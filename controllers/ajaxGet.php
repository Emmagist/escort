      ...
      if (Ajax::getAllEscortsBySlug($slug)) {
          ...
          <div class="card overflow-hidden rounded-2" style="width:250px">
            ...
            <div class="card-body pt-3 p-4">
              <h6 class="fw-semibold fs-4">'.ucwords($key['username']).'</h6>
      ...
      if (Ajax::getEscortById($token)) {
        foreach (Ajax::getEscortById($token) as $key) {
          $outPut .= '
            ...
            <div class=" d-flex"><button class=" btn btn-warning" style="margin-right: 20px;">Cancel</button><button type="button" onclick="book(`'.$key['user_id'].'`)" class="btn btn-primary">Book Now</button></div>
          ';
        }
      }
